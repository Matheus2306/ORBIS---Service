...
1. Consolidar gate local reproduzível com evidências de build/testes/scanners. Kestrel HTTPS/VerifyFull e métricas nativas com atributos controlados passaram em 119 testes. Confirmar gerador/coleta externa antes da carga.
