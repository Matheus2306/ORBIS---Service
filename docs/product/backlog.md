...
| F6 | P0 | CI reproduzível | Restore locked, format, build, testes, scanners e perf smoke | em curso: gate local com manifesto aprovado; CI remoto/imagem/perf smoke pendentes |
