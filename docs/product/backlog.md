...
| F4 | P0 | Criação/aceite/conclusão e auditoria | Idempotência, 100 atualizações concorrentes, atomicidade | em curso: criação primeiro |
| F3b | P0 | Listagem de ordens com keyset | Autorização no SQL, limite/cursor, contrato e isolamento | pendente |
