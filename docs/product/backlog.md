...
| F5 | P0 | Dataset Small e baseline Release | RPS/percentis/erros + métricas do gerador e servidor | em curso: Small uniforme/hot reproduzidos, 108 testes; planos/carga pendentes |
