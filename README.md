...
A suíte corrente possui [140 testes aprovados](docs/testing/reports/2026-09-22-api-controllers.md), 26 casos das regras e 12 checks do gate local. Inclui contratos dos controllers, atributos controlados de métricas HTTP/TLS/pool e gerador HTTPS externo compilado de fontes fixadas, com dependências auditadas e rejeições de certificado/tenant/token. [Observabilidade](docs/operations/observability.md) distingue emissão de sinais de coleta/alertas pendentes. Esses testes não comprovam carga ou escala.
