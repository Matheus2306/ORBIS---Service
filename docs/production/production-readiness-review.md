...
| Isolamento/autorização | PostgreSQL e ciclo de ordens testados; restante pendente | 98 testes no relatório de transições; novos componentes exigem testes próprios |
