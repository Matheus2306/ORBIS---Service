...
| Isolamento/autorização | PostgreSQL, ciclo de ordens e dataset testados; restante pendente | 108 testes no relatório de dataset; novos componentes exigem testes próprios |
