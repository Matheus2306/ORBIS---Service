...
| Isolamento/autorização | PostgreSQL, detalhe/lista e criação idempotente testados; restante pendente | 86 testes no relatório de listagem; novos componentes exigem testes próprios |
