...
| F5 | P0 | Dataset Small e baseline Release | RPS/percentis/erros + métricas do gerador e servidor | em curso: Small, 960 amostras SQL sob RLS, TLS e Kestrel HTTPS; 118 testes; carga HTTP pendente |
