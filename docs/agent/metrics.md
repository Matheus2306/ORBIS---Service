...
| Testes | 126/126 aprovados; 0 ignorados | docs/testing/reports/2026-09-22-load-generator.md |
...
| Gate local | 12 checks aprovados, 126 testes + 26 casos das regras; pins divergentes rejeitados | docs/testing/reports/2026-09-22-load-generator.md; CI remoto não executado |
